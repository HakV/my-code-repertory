...
from octopunch.db.sqlalchemy import models

from octopunch import exception
from octopunch.i18n import _


CONF = cfg.CONF
CONF.import_group("profiler", "octopunch.service")
LOG = logging.getLogger(__name__)

options.set_defaults(CONF, connection='sqlite:///$state_path/octopunch.sqlite')
...
def vcenter_create(context, values):
    """Create vcenter Update's to make the model like dict.
